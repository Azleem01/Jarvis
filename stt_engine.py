...
class Transcriber:
    ...
    _CONTEXT_PROMPT = (
        "Voice commands for a Windows desktop assistant: open Notepad, open "
        "Chrome, open File Explorer, launch Calculator, search for a file in "
        "Downloads, send a WhatsApp message, click the button on screen."
    )
    ...
    def transcribe(self, audio: np.ndarray) -> str:
        ...
        if peak >= self._SILENCE_PEAK:
            ...
            return self._run(audio, vad=False)
        return ""
